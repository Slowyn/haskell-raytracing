...
import Text.Printf
import Textures.Checker (mkCheckerTexture)
import Textures.Image (mkImageTexture)
import Textures.Perlin (mkNoiseTexture)
import Textures.SolidColor (SolidColor (SolidColor))
import Vec3 (Vec3 (..))
